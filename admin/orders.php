							...
							<div class="table-responsive">
								<table class="table " id="dataTable" width="100%" cellspacing="0">
									...
									<tbody>
										...
										$query = "SELECT * FROM `orders_all` order by `ord_id` asc";
										...
										while($row = $data->fetch_assoc())
										{
											...
											<tr>
												...
												if($row["ord_status"] == 0)
												{
													echo '<td><i class="fas fa-check-circle text-success"></i> Delivered</td>';
								...
								<!-- modal -->
								<div class="modal fade" id="orddetail" tabindex="-1" role="dialog"
									aria-labelledby="orddetail" aria-hidden="true">
