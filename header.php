        ...
        <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
            ...
            <div class="u-custom-menu u-nav-container">
                <ul class="u-custom-font u-nav u-unstyled u-nav-1">
                    ...
                    <?php
                                            $sql_item = "SELECT * FROM `category` WHERE active='1' order by id " ;
                                            $data_ret = mysqli_query($conn, $sql_item);
                    ...
                    <li class="u-nav-item">
                        ...
                        <div class="u-nav-popup">
                            <ul class="u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-nav-2">
                                ...
                                <?php
                                            while($ret_menu = mysqli_fetch_assoc($data_ret)){
                                            
                                         
                               echo "<li class='u-nav-item'><a class='u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-custom-color-1 u-white' href='menu.php#".$ret_menu['category']."'>".$ret_menu['category']."</a></li>";
                    ...
                    <div class="u-sidenav-overflow">
                        ...
                        <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-3">
                            ...
                            <li class="u-nav-item">
                               ...
                               echo "<li class='u-nav-item'><a class='u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-custom-color-1' href='menu.php#".$ret_menu['category']."'>".$ret_menu['category']."</a></li>";
                            ...
                            <?php $user(); ?>
                            <!-- <li class="u-nav-item"> <a class="u-button-style u-nav-link"
                            href="login.php" style="padding: 10px 20px;">LOGIN</a> </li> -->
                        </ul>
                    </div>
                </div>
