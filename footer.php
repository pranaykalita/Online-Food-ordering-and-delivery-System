...
<body>
 ...
 <a
     ...
     data-image-height="127">
     <img
         src="images/logoNew.png"
         class="u-logo-image u-logo-image-1"
         data-image-width="146.9412">
 </a>
 <!-- social icons -->
 <div
     ...
     <a class="u-social-url" target="_blank" href="">
         <span
             ...
             <svg
                 ...
                 viewbox="0 0 112 112"
                 >
                 <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-2f5a"></use>
             </svg>
             <svg
     ...
     <a class="u-social-url" target="_blank" href="">
         <span class="u-icon u-icon-circle u-social-twitter u-social-type-logo u-icon-2">
             <svg
                 ...
                 viewbox="0 0 112 112"
                >
                 <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-feab"></use>
             </svg>
             <svg
                 xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink"
     ...
     <a class="u-social-url" target="_blank" href="">
         <span
             ...
             <svg
                 ...
                 viewbox="0 0 112 112"
                >
                 <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-0238"></use>
             </svg>
             <svg
                 xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink"
     ...
     <a class="u-social-url" target="_blank" href="">
         <span
             class="u-icon u-icon-circle u-social-linkedin u-social-type-logo u-icon-4">
             <svg
                 class="u-svg-link"
                 preserveaspectratio="xMidYMin slice"
                 viewbox="0 0 112 112"
                >
                 <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-489a"></use>
             </svg>
             <svg
                 xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink"
         ...
         <div class="u-layout-row">
             ...
             <div class="u-container-style u-layout-cell u-size-20 u-layout-cell-1">
                 <div
                     ...
                     <p class="u-align-center u-text u-text-custom-color-2 u-text-1">Our Specialites</p>
                     <ul
                         class="u-align-center-sm u-align-center-xs u-align-left-lg u-align-left-md u-align-left-xl u-custom-font u-text u-text-white u-text-2">
                         <li>Chicken Items</li>
                         <li>pizza</li>
                         <li>Rolls</li>
                     </ul>
             ...
             <!-- section row 2 with side icons -->
             <div class="u-container-style u-layout-cell u-size-20 u-layout-cell-2">
                 <div class="u-container-layout u-valign-top u-container-layout-2">
                     <p class="u-text u-text-custom-color-2 u-text-3">Contact Us</p>
                     <ul
                         class="u-align-center-sm u-align-center-xs u-custom-font u-custom-list u-text u-text-4">
                         <li>
             ...
             <div class="u-container-style u-layout-cell u-size-20 u-layout-cell-3">
                 <div class="u-container-layout u-container-layout-3">
                     <p
                         class="u-align-center-sm u-align-center-xs u-text u-text-custom-color-2 u-text-5">Opening hours</p>
                     <p class="u-align-center u-custom-font u-text u-text-white u-text-6">MON -FRI<br>9AM - 8PM
                     </p>
                 </div>
             </div>
             <!-- end -->
 ...
 <!-- end copyright -->
 <div
     class="u-container-style u-custom-color-2 u-expanded-width u-group u-group-1">
     <div class="u-container-layout u-valign-middle u-container-layout-4">
         <p
             class="u-align-center u-custom-font u-font-montserrat u-small-text u-text u-text-variant u-text-7">All rights Reserved Copyright © 2020 Priyanshu | Pranay</p>
     </div>
 </div>
 <!-- end cpy -->
</footer>
